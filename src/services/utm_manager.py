    ...
    def _create_default_data_file(self):
        ...
        try:
            ...
            initial_data = {
                ...
                "campaigns": {
                    "spb": [
                        ["Все мероприятия (театры, концерты, опера, балет, стендап)", "spektakl_spb"],
                        ["Туры в Карелию", "kareliya_spb"],
                        ["Автобусная экскурсия по городу", "avtexcursion_spb"],
                        ["Пешеходная экскурсия по городу", "peshexcursion_spb"],
                        ["Экскурсия по пригородам", "prigorod_spb"],
                        ["Прогулки на теплоходе", "korabli_spb"],
                        ["Места (мастер классы, музеи, выставки, САПЫ)", "mesta_spb"],
                        ["Аквапарк", "akvapark_spb"],
                        ["Аренда теплоходов/катеров", "arenda_spb"],
                        ["Другое (что не подошло ни к одной категории, или общая публикация на сервис, бренд, конкуренты, ретаргетинг, общие подборки)", "other_spb"],
                        ["Туры по России", "tury_spb"]
                    ],
                    "msk": [
                        ["Все мероприятия (театры, концерты, опера, балет, стендап)", "spektakl_msk"],
                        ["Автобусные экскурсии в Москве", "avtexcursion_msk"],
                        ["Пешеходные экскурсии в Москве", "peshexcursion_msk"],
                        ["Корабли в Москве", "korabli_msk"],
                        ["Места (мастер классы, музеи, выставки, сапы, каяки, рафтинг,  спа, смотровые)", "mesta_msk"],
                        ["Другое (что не подошло ни к одной категории)", "other_msk"]
                    ],
                    "regions": [
                        ["Все позиции в Сочи", "sochi"],
                        ["Все позиции в Казани", "kazan"],
                        ["Все позиции в Калининграде", "kaliningrad"],
                        ["Все позиции в Нижнем Новгороде", "nn"],
                        ["Все позиции в Анапе", "anapa"],
                        ["Все позиции в Кисловодске", "kislovodsk"],
                        ["Все позиции в Дагестане", "dagestan"],
                        ["Все позиции во Владикавказе", "osetia"],
                        ["Все позиции в Геленджике", "gelendghik"],
                        ["Все позиции в Крыму", "crimea"],
                        ["Все позиции в Севастополе", "sevastopol"],
                        ["Все позиции в Ялте", "yalta"],
                        ["Все позиции в Пскове", "pskov"],
                        ["Экскурсии в регионах (общие кампании и подборки)", "regions"],
                        ["Все позиции в Ярославле", "yar"],
                        ["Все позиции в Костроме", "kostroma"],
                        ["Все позиции в Суздале", "suzdal"],
                        ["Все позиции в Вологде", "vologda"],
                        ["Все позиции в Рязани", "ryazan"],
                        ["Все позиции в Краснодарском крае", "krasnodar"],
                        ["Все позиции в Петрозаводске", "petrozavodsk"],
                        ["Все позиции в Ростове", "rostov"],
                        ["Все позиции на Байкале", "baikal"],
                        ["Все позиции в Мурманске", "murmansk"],
                        ["Все позиции в Смоленске", "smolensk"],
                        ["Все позиции в Выборге", "vuborg"],
                        ["Все позиции в Великом Новгороде", "veliky"],
                        ["Все позиции в Новосибирске", "nsk"],
                        ["Все позиции во Владивостоке", "vladivostok"],
                        ["Все позиции в Туле", "tula"],
                        ["Все позиции в Коломне", "kolomna"]
                    ],
                    "foreign": [
                        ["Все позиции в Анталье", "antalya"],
                        ["Все позиции в Тбилиси", "tbilisi"],
                        ["Все позиции в Шарм-эль-Шейхе", "sharmelsheikh"],
                        ["Все позиции в Стамбуле", "stambul"],
                        ["Все позиции в Пекине", "pekin"],
                        ["Все позиции в Баку", "baku"],
                        ["Все позиции в Шардже", "sharjah"],
                        ["Все позиции в Дубае", "dubai"],
                        ["Все позиции в Аджмане", "ajman"],
                        ["Все позиции в Фуджейре", "fujairah"],
                        ["Все позиции в Рас-эль-Хайме", "ras-al-khaima"],
                        ["Все позиции в Абу-Даби", "abu-dabi"],
                        ["Все позиции в Минске", "minsk"],
                        ["Все позиции в Абхазии", "abhazia"],
                        ["Все позиции в Грузии", "georgia"],
                        ["Все позиции в Алма-Ата", "almatu"]
                    ]
                }
            }
